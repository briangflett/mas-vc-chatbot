...
MAS does not charge fees for its services, but we do ask organizations that are financially able to do so to consider giving MAS a donation at the completion of a project. Donations are contributions toward covering the MAS operating expenses.